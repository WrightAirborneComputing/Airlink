...
try:
    ...
    # RC uplink receiver: WFB p0 -> local UDP 9000 -> CRSF
    rcRxer = RcPacketReceiver(name="RC-UP",
        in_port=rcRxerConfig.udp_port,
        ack_port=rcTxerConfig.udp_port,
        channel_callback=rcTxer.set_channels_us,
        led=rcLed,
    )
    ...
    # VIDEO downlink: PiCam -> local UDP 9004 -> WFB p4
